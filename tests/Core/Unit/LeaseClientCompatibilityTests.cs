...
{
    [Fact]
    public async Task should_preserve_legacy_custom_client_and_one_argument_callbacks()
    {
    ...
    [Fact]
    public async Task should_fail_clearly_given_authority_callback_on_legacy_custom_client()
    {
        ILeaseClient client = new LegacyLeaseClient();
    ...
    private sealed class LegacyLeaseClient : ILeaseClient
    {
        ...
        {
            return Task.FromException<ILease>(new NotSupportedException());
        }
        ...
        {
            return Task.FromException<LeaseInfo>(new NotSupportedException());
        }
        ...
        public Task<LeaseSubscription> SubscribeAsync(
            ...
            CancellationToken ct = default)
        {
            return Task.FromException<LeaseSubscription>(new NotSupportedException());
        }
    }
}
