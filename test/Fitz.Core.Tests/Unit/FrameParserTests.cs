...
{
    [Fact]
    public void ShouldParseTwoFramesGivenBufferWithMultipleFramesWhenParsingOnce()
    {
        // Arrange
    ...
    [Fact]
    public void ShouldParseFrameAfterSecondChunkGivenPartialFrameWhenDataArrivesInTwoReads()
    {
        // Arrange
        var parser = new FrameParser();
    ...
    [Fact]
    public void ShouldReadFramesSequentiallyGivenBufferedDataWhenTryReading()
    {
        // Arrange
        var parser = new FrameParser();
        var first = FrameCodec.Encode(100, [0x1, 0x2]);
