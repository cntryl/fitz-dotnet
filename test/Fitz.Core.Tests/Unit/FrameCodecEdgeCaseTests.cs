...
{
    [Fact]
    public void ShouldRoundTripMessageTypeZero()
    {
    ...
    [Fact]
    public void ShouldEncodeType254AsSingleByte()
    {
    ...
    [Fact]
    public void ShouldRequireEscapeForType255()
    {
    ...
    [Fact]
    public void ShouldRoundTripType256()
    {
    ...
    [Fact]
    public void ShouldRoundTripMaximumMessageType()
    {
    ...
    [Fact]
    public void ShouldRoundTripLargePayload()
    {
    ...
    [Fact]
    public void ShouldRoundTripMaximumSizePayload()
    {
    ...
    [InlineData(127)]
    [InlineData(254)]
    public void ShouldUseSingleByteForSmallTypes(ushort messageType)
    {
    ...
    [InlineData(1000)]
    [InlineData(65535)]
    public void ShouldUseEscapeForLargeTypes(ushort messageType)
    {
    ...
    [Fact]
    public void ShouldPreserveAllByteValues()
    {
