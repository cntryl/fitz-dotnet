...
public sealed class DomainWorkflowIntegrationTests
{
    ...
    [Fact]
    public async Task ShouldRoundTripRpcResponseGivenRegisteredWorker()
    {
    ...
    [Fact]
    public async Task ShouldDeliverNoticeGivenSubscribePublishWorkflow()
    {
        var route = IntegrationFixture.CreateUniqueRoute("notice");
        await using var client = IntegrationFixture.CreateAnonymousClient(IntegrationFixture.GetAnonymousWebSocketUrl());
        await client.ConnectAsync();
    ...
    [Fact]
    public async Task ShouldRoundTripQueueMessageGivenEnqueueReserveCompleteWorkflow()
    {
        var route = IntegrationFixture.CreateUniqueRoute("queue");
        await using var client = IntegrationFixture.CreateAnonymousClient(IntegrationFixture.GetAnonymousWebSocketUrl());
        await client.ConnectAsync();
    ...
    [Fact]
    public async Task ShouldRoundTripStreamRecordsGivenBeginAppendCommitReadWorkflow()
    {
        var route = IntegrationFixture.CreateUniqueRoute("stream");
        await using var client = IntegrationFixture.CreateAnonymousClient(IntegrationFixture.GetAnonymousWebSocketUrl());
        await client.ConnectAsync();
    ...
    [Fact]
    public async Task ShouldRoundTripFilteredStreamRecordsGivenDiscriminatorFilterWorkflow()
    {
        var route = IntegrationFixture.CreateUniqueRoute("stream");
        await using var client = IntegrationFixture.CreateAnonymousClient(IntegrationFixture.GetAnonymousWebSocketUrl());
        await client.ConnectAsync();
    ...
    [Fact]
    public async Task ShouldHoldThenReleaseLeaseGivenAcquireExtendReleaseWorkflow()
    {
        var route = IntegrationFixture.CreateUniqueRoute("lease");
        await using var client = IntegrationFixture.CreateAnonymousClient(IntegrationFixture.GetAnonymousWebSocketUrl());
        await client.ConnectAsync();
    ...
    [Fact]
    public async Task ShouldCreateAndCancelScheduleGivenValidCronWorkflow()
    {
    ...
    [Fact]
    public async Task ShouldWriteThenReadKvValueGivenTransactionCommitWorkflow()
    {
