...
sealed record ConformanceRunConfig(
    string SuitePath,
    string ClientName,
    string Transport,
    string AuthMode,
...
static class ConformanceResultBuilder
{
...
static class ConformanceScenarioCatalog
{
    static readonly Lazy<IReadOnlyDictionary<string, (string Title, string Priority)>> Definitions = new(() =>
    {
