...
public interface IStreamClient
{
    ...
    Task<IReadOnlyList<StreamRecord>> ReadAsync(string route, ulong startOffset, ulong limit = 100, ulong? maxBytes = null, CancellationToken cancellationToken = default);
