...
| MUX-7 | confirmed | Multiplexer request and notification scans use allocation-free loops rather than LINQ. RPC worker route selection remains a separate O(n) pattern scan with per-candidate parsing and is not covered by this disposition. |
